...
<head>
    <meta charset="UTF-8">
    <title>Import itin\u00e9raires - Administration</title>
    ...
    <div class="main">
        <div class="table-container">
            <div class="table-header">
                <h1>Import d'itin\u00e9raires</h1>
                <a href="${pageContext.request.contextPath}/itineraire" class="btn-add">
            ...
            <div class="form-card" style="max-width:600px;margin:2rem auto;padding:2rem;background:#fff;border-radius:8px;box-shadow:0 2px 8px rgba(0,0,0,.08);">
                ...
                <p style="margin-bottom:1.5rem;color:#666;font-size:0.9rem;">
                    Le fichier doit contenir les colonnes : <strong>nomZone</strong>, <strong>lieuExact</strong>,
                    <strong>heureDebutPrevue</strong> (HH:mm), <strong>heureFinPrevue</strong> (HH:mm),
                    <strong>jourSemaine</strong> (LUNDI, MARDI...).
                </p>

                <form method="post" action="${pageContext.request.contextPath}/itineraire/import"
