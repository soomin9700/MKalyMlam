...
<head>
    <meta charset="UTF-8">
    <title>Import \u00e9quipe - Administration</title>
    ...
    <div class="main">
        <div class="table-container">
            <div class="table-header">
                <h1>Import d'affectations \u00e9quipe</h1>
                <a href="${pageContext.request.contextPath}/equipe/list_equipe" class="btn-add">
            ...
            <div class="form-card" style="max-width:600px;margin:2rem auto;padding:2rem;background:#fff;border-radius:8px;box-shadow:0 2px 8px rgba(0,0,0,.08);">
                ...
                <p style="margin-bottom:1.5rem;color:#666;font-size:0.9rem;">
                    Le fichier doit contenir les colonnes : <strong>idSession</strong>,
                    <strong>idUtilisateur</strong>, <strong>idRoleDuJour</strong>,
                    <strong>salaireJournalierRemplacant</strong> (optionnel, requis si REMPLACANT).
                </p>

                <form method="post" action="${pageContext.request.contextPath}/equipe/import"
