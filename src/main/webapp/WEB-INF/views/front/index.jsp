...
<body>
        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container">
                <a class="navbar-brand logo-container" href="#">
                    <img src="${pageContext.request.contextPath}/images/logo1.jpg" alt="Logo Mkaly Mlam" class="logo-img" onerror="this.src='images/logo.jpg'">
                ...
                <div class="collapse navbar-collapse" id="mainNav">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0 align-items-lg-center gap-2">
                        ...
                        <li class="nav-item"><a class="nav-link" href="#live-location">Où nous trouver ?</a></li>
    ...
    <main>
                ...
                <div class="row align-items-center gx-5">
                    <div class="col-lg-6 hero-text text-center text-lg-start mb-5 mb-lg-0">
                        ...
                        <p class="lead mb-4 text-muted">
                            Des burgers juteux, des tacos dorés, des hot dogs gourmands et nos spécialités inédites cuisinés sous vos yeux avec amour et produits frais.
                        </p>
                        ...
                        <div class="mt-5 d-flex justify-content-center justify-content-lg-start gap-4">
                            <div><span class="fw-bold text-primary">★ 4.9</span> <span class="text-muted">(250+ avis gourmands)</span></div>
                            <div><span class="fw-bold text-primary">100%</span> <span class="text-muted">Fait Maison / Vita Malagasy</span></div>
                        </div>
                    </div>
                    <div class="col-lg-6 hero-image-container">
                        <img src="${pageContext.request.contextPath}/images/home-hero.jpg" alt="Mkaly Mlam Hero" class="img-fluid" onerror="this.src='images/burger.jpg'">
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="truck-localization-section py-5">
            <div class="container">
                <div class="text-center mb-5">
                    ...
                    <p class="section-subtitle">Retrouvez nos emplacements stratégiques et suivez nos déplacements de la journée.</p>
                </div>
                
                <div class="cards-container d-flex flex-wrap justify-content-center gap-4">
                    <c:forEach var="itineraire" items="${itineraires}">
                        <div class="recap-card">
                            <div class="card-content">
                                <h3 class="truck-name">${itineraire.truckName}</h3>
                                <p class="localization-text">
                                    <span class="icon"><i class="fas fa-location-dot"></i></span> ${itineraire.nomZone} - ${itineraire.lieuExact}
                                </p>
                                <p class="schedule-text">
                                    <span class="icon"><i class="fas fa-clock"></i></span> ${itineraire.schedule}
                                </p>
                            </div>
                            <button class="btn-itinerary" onclick="showItinerary('${itineraire.id}')">
                ...
                <div id="itinerary-section" class="itinerary-section" style="display: none;">
                    <div class="itinerary-header">
                        <h4 class="fw-bold mb-0"><i class="fas fa-truck me-2 text-primary"></i>Détails de l'itinéraire : <span id="selected-truck" class="text-primary">Nom du Truck</span></h4>
        ...
        <section class="featured-products" id="featured-section">
            <div class="container">
                <div class="text-center mb-5">
                    ...
                    <p class="section-subtitle">Nos meilleures ventes et nos dernières créations à ne surtout pas manquer !</p>
                </div>
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="card product-card h-100">
                                <div class="card-img-wrapper">
                                    <img src="${pageContext.request.contextPath}/${produit.img}" alt="${produit.name}" onerror="this.src='${pageContext.request.contextPath}/images/logo.jpg'">
                                    <c:choose>
                                        <c:when test="${produit.tag == 'new'}">
                                            <span class="product-badge badge-new"><i class="fas fa-sparkles me-1"></i>Nouveau</span>
                                        </c:when>
                                        <c:otherwise>
                                            <span class="product-badge badge-popular"><i class="fas fa-star me-1"></i>Populaire</span>
                                        </c:otherwise>
                                    </c:choose>
                                </div>
                                <div class="card-body d-flex flex-column">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mt-3">
                                        <span class="stars"><i class="fas fa-star"></i> 4.8 • ${produit.category}</span>
                                        <button class="btn-add btn-sm btn"><i class="fas fa-plus me-1"></i>Ajouter</button>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <section class="menu-section" id="menu-complet">
            <div class="container">
                <div class="text-center mb-5">
                    ...
                    <p class="section-subtitle">Faites votre choix parmi nos délicieuses recettes préparées minute.</p>
                    ...
                    <div class="d-flex flex-wrap justify-content-center gap-2 mb-4" id="category-filters">
                        ...
                        <button class="filter-btn" onclick="filterCategory('accompagnements')">Accompagnements</button>
                    </div>
                </div>
        ...
        <section class="reviews-section" id="avis-clients">
            <div class="container">
                <div class="row g-5">
                    <!-- Liste des Avis existants -->
                    <div class="col-lg-6">
                        <h2 class="section-title mb-2">Avis de nos Gourmands</h2>
                        <p class="text-muted mb-4">Ceux qui en parlent le mieux sont ceux qui ont goûté !</p>
                        ...
                        <div class="d-flex flex-column gap-3" id="reviews-list">
                            ...
                            <div class="review-card">
                                <div class="d-flex align-items-center justify-content-between mb-3">
                                    <div class="d-flex align-items-center gap-3">
                                        <div class="review-avatar d-flex align-items-center justify-content-center bg-primary text-white fw-bold">R</div>
                                        <div>
                                            <h6 class="fw-bold mb-0">Rova</h6>
                                ...
                                <p class="mb-0 text-muted">"Le Boss Burger est tout simplement incroyable ! La sauce est délicieuse et le steak super juteux. Service rapide !"</p>
                            </div>
                            ...
                            <div class="review-card">
                                <div class="d-flex align-items-center justify-content-between mb-3">
                                    <div class="d-flex align-items-center gap-3">
                                        <div class="review-avatar d-flex align-items-center justify-content-center bg-warning text-dark fw-bold">H</div>
                                        <div>
                                            <h6 class="fw-bold mb-0">Hery</h6>
                                ...
                                <p class="mb-0 text-muted">"Très bons tacos, portion ultra généreuse. On sent que les ingrédients sont frais. Je recommande !"</p>
                            </div>
                        </div>
                    </div>

                    <!-- Formulaire pour Publier un Avis -->
                    <div class="col-lg-6">
                        <div class="review-form-container">
                            <h3 class="fw-bold mb-2">Donnez-nous votre avis !</h3>
                            <p class="text-muted mb-4">Votre retour nous aide à toujours plus vous régaler.</p>
                            
                            <form id="add-review-form" onsubmit="submitReview(event)">
                                <div class="mb-3">
                                    <label class="form-label fw-semibold">Votre prénom</label>
                                    <input type="text" class="form-control rounded-3 py-2" id="reviewer-name" placeholder="Ex: Nampoina" required>
                                </div>
                                
                                <div class="mb-3">
                                    <label class="form-label fw-semibold d-block">Votre note</label>
                                    <div class="rating-input d-flex gap-2" id="star-selector">
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea class="form-control rounded-3" id="reviewer-comment" rows="4" placeholder="Qu'avez-vous pensé de votre dégustation ?" required></textarea>
                                </div>

                                <button type="submit" class="btn btn-primary w-100 py-3 rounded-pill fw-bold btn-hero">
        ...
        <div class="container">
            <div class="row g-4">
                <div class="col-md-4">
                    ...
                    <p class="text-white-50 small">La street food qui réveille vos papilles à Antananarivo. Des recettes authentiques et gourmandes cuisinées avec passion.</p>
