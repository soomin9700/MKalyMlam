...
// @Test
// void newLotIngredientPageShouldRenderFormView() throws Exception {
// when(lotIngredientService.getAll()).thenReturn(List.of());
// when(ingredientService.findAll()).thenReturn(List.of());
// when(typeMouvementService.findAll()).thenReturn(List.of());

// mockMvc.perform(get("/lot/ingredients/new"))
// .andExpect(status().isOk())
// .andExpect(view().name("lotIngredient/form"));
// }
// }
